export function Option3() {
  const svgLarge = (size: number) => (
    <svg width={size} height={size} viewBox="0 0 180 180" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <circle cx="90" cy="90" r="58" stroke="#C4855A" stroke-width="5" fill="none"/>
      <circle cx="90" cy="90" r="44" stroke="white" stroke-width="1.5" fill="none" opacity="0.3"/>
      <line x1="90" y1="32" x2="90" y2="148" stroke="white" stroke-width="1.5" opacity="0.3"/>
      <line x1="32" y1="90" x2="148" y2="90" stroke="white" stroke-width="1.5" opacity="0.3"/>
      <polygon points="90,38 96,58 90,54 84,58" fill="#C4855A"/>
      <text x="90" y="100" fontFamily="Georgia, serif" fontSize="36" fontWeight="700" fill="white" textAnchor="middle" letterSpacing="0">WJ</text>
    </svg>
  );
  return (
