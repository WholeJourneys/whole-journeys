export function Option5() {
  const svg = (size: number) => (
    <svg width={size} height={size} viewBox="0 0 180 180" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <line x1="30" y1="112" x2="150" y2="112" stroke="#C4855A" strokeWidth="2.5"/>
      <path d="M30 125 Q90 108 150 125" stroke="#C4855A" strokeWidth="2" fill="none" opacity="0.5"/>
      <path d="M38 138 Q90 116 142 138" stroke="#C4855A" strokeWidth="1.5" fill="none" opacity="0.3"/>
      <path d="M25 100 Q90 60 155 100" stroke="white" strokeWidth="1.5" fill="none" opacity="0.2"/>
    </svg>
  );
  return (
    <div className="min-h-screen bg-gray-100 flex flex-col items-center justify-center gap-6 p-8">
      <div className="bg-white rounded-2xl shadow-lg p-8 flex flex-col items-center gap-5">
        ...
        <p className="text-base font-semibold text-gray-800 text-center">WJ with Horizon Lines</p>
