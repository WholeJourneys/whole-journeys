  ...
  return (
    <>
      ...
      <Dialog.Root open={isOpen} onOpenChange={(open) => !open && onClose()}>
        ...
        <Dialog.Content className="fixed inset-0 sm:inset-auto sm:left-[50%] sm:top-[50%] z-[110] w-full sm:max-w-4xl sm:translate-x-[-50%] sm:translate-y-[-50%] border-none bg-background shadow-2xl duration-200 data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 data-[state=closed]:slide-out-to-left-1/2 data-[state=closed]:slide-out-to-top-[48%] data-[state=open]:slide-in-from-left-1/2 data-[state=open]:slide-in-from-top-[48%] sm:rounded-2xl overflow-hidden sm:max-h-[90vh] flex flex-col">
