...
export const TRAVEFY_TOURS: Tour[] = [
  ...
  },
  {
    ...
    price: null,
    groupSize: "Private departures for 2+",
    categories: ["Long Distance Walks", "Walk/Hike", "Self-Guided"],
  ...
  },
  {
    ...
    price: null,
    groupSize: "Private departures for 2+",
    categories: ["Culture", "Villas/Farms", "Self-Drive"],
  ...
  },
  {
    ...
    price: null,
    groupSize: "Private departures for 2+",
    categories: ["Villas/Farms", "Culture", "Wellness"],
  ...
  return useQuery({
    ...
    queryFn: async () => {
      ...
      const hardcoded = TRAVEFY_TOURS.map((tour, idx) => {
        ...
        return {
          ...tour,
          name: content?.tourName ?? tour.name,
