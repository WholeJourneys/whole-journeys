...
const DEFAULTS: Record<string, string> = {
  ...
  about_bio_1b: "In 1994 I became one of the first employees at Country Walkers, where I helped grow the company from 300 to 3,000+ guests, personally researched and designed over 70% of its worldwide walking vacations, and trained local guides across more than 30 countries.",
  about_bio_1c: "Four years later, in 1998, I founded my own company, The Dragon's Path, offering cultural walking vacations worldwide. During that period I also created ActiveWomen.com and began speaking publicly on the influence and importance of what I called \"Prime Time Women\" — women between 50 and 70 — and their forceful influence on the travel industry.",
  about_bio_2: "Around 2006, I consulted for EONS.com, an ambitious Boomer-focused platform, and built out their travel division. I later took over the site and relaunched it as TravelDragon.com — a curated search engine that today hosts 8,000+ itineraries from 1,700+ boutique travel providers. In 2016 and 2018, I consulted for two World Bank teams on the ground — in St. Lucia, Grenada, and Tajikistan — reviewing tourism and agricultural products for food tourism development. Between 2016 and 2017, I also served as Activities Concierge aboard the National Geographic Orion for Lindblad Expeditions, developing independent hiking, biking, and food and wine experiences for guests throughout Europe, the British Isles, and Scandinavia.",
