      ...
      <div className="flex-grow max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 w-full">
        ...
        {hasFilters && (
          <div className="flex items-center justify-between mb-6">
            {fallbackMode ? (
              <div className="flex items-center gap-3 text-sm text-white bg-amber-800 border-2 border-amber-900 px-4 py-3 rounded-xl shadow-md font-semibold w-full">
                <span className="text-amber-200 text-base flex-shrink-0">⚠</span>
                ...
                <button onClick={clearAll} className="ml-1 px-3 py-1.5 text-xs font-semibold bg-white hover:bg-amber-50 text-amber-900 rounded-lg transition-colors whitespace-nowrap flex-shrink-0">Clear filters</button>
              </div>
            ) : (
