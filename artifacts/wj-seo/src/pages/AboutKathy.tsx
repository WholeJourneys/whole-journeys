    ...
    <div>
      ...
      <article className="max-w-3xl mx-auto px-4 py-14">
        <div className="prose-wj">
          ...
          <p>
            John Mackey — the founder and CEO of Whole Foods Market — has been a personal client of Kathy Dragon's for more than 25 years, across more than 15 countries, with 8+ additional trips together since 2016 — including after Kathy took Whole Journeys fully independent and after the Amazon acquisition of Whole Foods. His testimonial is not a marketing endorsement from a one-time guest. It is the assessment of someone who has traveled with Kathy repeatedly across a quarter century, and who keeps coming back:
          </p>
