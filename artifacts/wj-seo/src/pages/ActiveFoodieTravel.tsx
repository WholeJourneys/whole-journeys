    ...
    <div>
      ...
      <article className="max-w-3xl mx-auto px-4 py-14">
        <div className="prose-wj">
          ...
          <p>
            The partnership with Whole Foods Market was not a licensing arrangement. It grew from a personal client relationship with John Mackey, the company's founder, who has traveled with Kathy across more than 15 countries over 25+ years — a relationship that has continued with 8+ additional trips since 2016, after Kathy took Whole Journeys fully independent. His assessment of her work — "she finds the best guides and takes my friends and I to destinations we'd never thought about traveling to" — is the most concise description of the active foodie travel philosophy: not the most obvious destination, not the most photographed restaurant, but the most specific, most local, most earned experience a destination can offer.
          </p>
          <p>
