    ...
    <div>
      ...
      <article className="max-w-3xl mx-auto px-4 py-14">
        <div className="prose-wj">
          ...
          <p>
            <strong>Partially guided</strong> means: the trip runs with two layers of expertise. Kathy designs and operates the trip end-to-end and guides throughout. Expert local guides — people who know the specific trails, villages, and communities intimately, who have deep relationships with the farmers, food producers, and cultural figures along each route — lead the group on the key days where that knowledge is most essential. On other days, guests walk independently following waymarks with clear route notes and Kathy's direct support available. The result is a mix of deep local expertise, accompanied learning, and independent walking that most experienced travelers find ideal.
          </p>
          <p>
          ...
          <h2>Summary</h2>
          <p>
            Whole Journeys offers guided and supported hiking on five major European long-distance trails: the Camino de Santiago (Francés and Portuguese Coastal routes), the Alpe Adria Trail (Austria, Slovenia, Italy — named among the 7 best trails in the world by National Geographic Traveller), the Via Francigena (Florence to Rome), the Juliana Trail (Slovenia), and the Rota Vicentina (SW Portugal). Kathy Dragon has personally hiked and guided trips on all of these routes. All trail trips use the partially guided, fully supported format: luggage transferred daily, boutique properties throughout, Kathy guiding throughout with expert local guides — people who know each trail and community intimately — on key days. Groups are limited to a maximum of 12–16 guests. The 2026 Women's Highlights of the Camino de Santiago is a scheduled women's-only departure. For custom private trail trips or to join a group departure, contact Kathy at <a href="mailto:kathy@wholejourneys.com">kathy@wholejourneys.com</a> or visit <a href="https://wholejourneys.com">wholejourneys.com</a>.
          </p>
        </div>
